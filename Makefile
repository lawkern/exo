...
desktop:
	@mkdir -p build
	$(CC) $(CFLAGS) ./src/desktop/renderer.cpp -c -Og -DDEVELOPMENT_BUILD=1 -o ./build/desktop_renderer_x64_debug.o
	$(CC) $(CFLAGS) ./src/desktop/renderer.cpp -c -O2 -DDEVELOPMENT_BUILD=0 -o ./build/desktop_renderer_x64_release.o

	$(CC) $(CFLAGS) ./src/desktop/sdl_main.c -DDEVELOPMENT_BUILD=1 -Og -o ./build/desktop_x64_debug   ./build/desktop_renderer_x64_debug.o   `pkg-config --cflags --libs sdl3`
	$(CC) $(CFLAGS) ./src/desktop/sdl_main.c -DDEVELOPMENT_BUILD=0 -O2 -o ./build/desktop_x64_release ./build/desktop_renderer_x64_release.o `pkg-config --cflags --libs sdl3`
